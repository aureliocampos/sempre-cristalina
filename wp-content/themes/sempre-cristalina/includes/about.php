<section id="smp-about" class="smp-about-section">
    <div class="container">
        <div class="d-flex flex-row justify-content-center">
            <div class="col-lg-10">
                <aside class="smp-about-text">
                    <h2 class="smp-title-B">Somos um time de profissionais de alta capacitação e em treinamento contínuo sobre as técnicas e tecnologias mais atuais do mercado de piscinas</h2>
                    <p class="smp-text-A">O compromisso da Sempre Cristalina é com o bem-estar e saúde dos nossos clientes. Só assim você e sua família poderão aproveitar ao máximo seu lazer.</p>
